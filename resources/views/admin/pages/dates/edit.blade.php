...
@section('title', "تعديل التاريخ")

@section('main')
<div class="content-wrapper">
    @include("admin.partiels.content-header",['text' => 'تعديل التاريخ'])
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="year" id="year" class="form-control" placeholder="السنة" value="{{ $date->year }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
